...
typedef enum
{
  ...
  CFG_TASK_DMA_FULL_ID,
  CFG_TASK_TRAIN_AI_REQ_ID,
  CFG_TASK_MOTOR_MONITOR_REQ_ID,
  CFG_TASK_BT_PUSH,
  CFG_TASK_DATA_LOGGER,

  CFG_TASK_LED_CONTROL_ID,
  CFG_EVT_LED_LEARNING_ID,
...
/** 
 * Data logger mode
 * To create your own AI Library wuth Nanoedge AI
 */
                                                            
#define DATA_LOGGER                             (0U)
...
#define CFG_LED_SUPPORTED                       (1U)
#define CFG_LCD_SUPPORTED                       (1U)
