...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
extern uint8_t Data_Input_Buffer_full;
/* USER CODE END 0 */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, DIRECTION_Pin|BRAKE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : DIRECTION_Pin BRAKE_Pin */
  GPIO_InitStruct.Pin = DIRECTION_Pin|BRAKE_Pin;
...
/* USER CODE BEGIN MX_GPIO_Init_2 */
  GPIO_InitStruct.Pin = Debug1a_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(Debug1a_GPIO_Port, &GPIO_InitStruct);
  
  GPIO_InitStruct.Pin = Debug2a_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(Debug2a_GPIO_Port, &GPIO_InitStruct);
  
  GPIO_InitStruct.Pin = Debug3a_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(Debug3a_GPIO_Port, &GPIO_InitStruct);
...
void Init_LED(){
  ...
  GPIO_InitStruct.Pin = DataLed1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(DataLed1_GPIO_Port, &GPIO_InitStruct);
  
  GPIO_InitStruct.Pin = DataLed2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(DataLed2_GPIO_Port, &GPIO_InitStruct);
  
  GPIO_InitStruct.Pin = DataLed3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(DataLed3_GPIO_Port, &GPIO_InitStruct);
  
  GPIO_InitStruct.Pin = DataLed4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(DataLed4_GPIO_Port, &GPIO_InitStruct);
  
  GPIO_InitStruct.Pin = ClkLed_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(ClkLed_GPIO_Port, &GPIO_InitStruct);
  
  BLINKT_Init(0, ClkLed_GPIO_Port, ClkLed_Pin, DataLed1_GPIO_Port, DataLed1_Pin);
  BLINKT_Init(1, ClkLed_GPIO_Port, ClkLed_Pin, DataLed2_GPIO_Port, DataLed2_Pin);
  BLINKT_Init(2, ClkLed_GPIO_Port, ClkLed_Pin, DataLed3_GPIO_Port, DataLed3_Pin);
  BLINKT_Init(3, ClkLed_GPIO_Port, ClkLed_Pin, DataLed4_GPIO_Port, DataLed4_Pin);
  
  for(int i=0; i<4; i++){
    BLINKT_SetBrightness(i, 7); 
  }
...
{
  Data_Input_Buffer_full = 1;
}

void HAL_GPIO_EXTI_Falling_Callback(uint16_t GPIO_Pin)
{
  UTIL_SEQ_SetTask(1<<CFG_TASK_BT_PUSH,CFG_SEQ_PRIO_0);
}
/* USER CODE END 4 */
