...
FC_APP_ConnHandleNotEvt_t FCHandleNotification;
...
{
  6, AD_TYPE_COMPLETE_LOCAL_NAME, 'F', 'C', '_', 'X', 'X',  /* Complete name */
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification(void *p_Pckt)
{
  ...
  switch (p_event_pckt->evt)
  {
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      FCHandleNotification.EvtOpcode = FC_DISCON_HANDLE_EVT;
      DISHandleNotification.EvtOpcode = DIS_DISCON_HANDLE_EVT;
      FCHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      DISHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      FC_APP_EvtRx(&FCHandleNotification);
      ...
      UTIL_LCD_DisplayStringAt(0, LINE(1), (uint8_t *)"AI Fan Project", CENTER_MODE);
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_ENHANCED_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          FCHandleNotification.EvtOpcode = FC_CONN_HANDLE_EVT;
          DISHandleNotification.EvtOpcode = DIS_CONN_HANDLE_EVT;
          FCHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          FCHandleNotification.EvtOpcode = FC_CONN_HANDLE_EVT;
          DISHandleNotification.EvtOpcode = DIS_CONN_HANDLE_EVT;
          FCHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
